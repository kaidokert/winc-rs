...
mod tests {
    ...
    fn test_read_intr_reg_no_crc() {
        ...
        assert_eq!(
            writebuf[..],
            [
                0x81, 0, 4, 0xC4, 0x80, 0x10, 0x00, 0xA2, 0, 1, 0xC4, 0xA2, 0, 1, 0, 0xA2, 0, 1, 0xF0,
                0xA2, 0, 4, 1, 2, 3, 4
            ]
        );
    }
    ...
    fn test_read_intr_reg_crc() {
        ...
        assert_eq!(
            writebuf[..],
            [
                0x81, 0, 5, 0xC4, 0x80, 0x010, 0x00, 0x64, 0xA2, 0, 1, 0xC4, 0xA2, 0, 1, 0x00, 0xA2, 0,
                1, 0xF0, 0xA2, 0, 4, 1, 2, 3, 4
            ]
        );
    }
    ...
    fn test_bus_reset() {
        let mut writebuf = [
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAA, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xCF, 0xFF, 0xFF, 0xFF,
            0x00
        ];
        let writer = writebuf.as_mut_slice();
        let mut chip = ChipAccess::new(PrefixXfer::new(writer));
        ...
        assert_eq!(
            writebuf[..],
            [
                0x81, 0, 5, 0xCF, 0xFF, 0xFF, 0xFF, 0xAA, 0xA2, 0, 1, 0xFF, 0xA2, 0, 1, 0xCF, 0xA2, 0, 1, 0
            ]
        );
    }
}
